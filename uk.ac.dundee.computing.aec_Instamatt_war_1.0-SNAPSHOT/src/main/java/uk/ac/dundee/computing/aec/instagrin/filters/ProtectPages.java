 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp","/UpdateDetails.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
